...
-- repeate loop
DECLARE My_Cursor CURSOR FOR  SELECT  city_code  FROM fpmx1018 where XHDWDM like 'shuih%' group by city_code order by city_code desc; -- 定义游标并输入结果集
