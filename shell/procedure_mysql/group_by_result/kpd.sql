...
begin -- 开始存储过程
declare fpcl_lv varchar(40); -- 自定义变量1
...
-- repeate loop
DECLARE My_Cursor CURSOR FOR  SELECT  kpd  FROM fpmx1018 where XHDWDM like 'shuih%' group by kpd order by kpd desc; -- 定义游标并输入结果集
